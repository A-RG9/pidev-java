...
import javafx.scene.layout.Region;  // AJOUTER CET IMPORT
...
public class GoalCardController {
    ...
    private void setupCardSize() {
        if (cardContainer != null) {
            ...
            cardContainer.setMinHeight(javafx.scene.layout.Region.USE_COMPUTED_SIZE);
            cardContainer.setMaxHeight(javafx.scene.layout.Region.USE_COMPUTED_SIZE);
