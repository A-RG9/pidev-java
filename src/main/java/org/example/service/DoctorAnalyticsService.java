...
/**
 * Service that communicates with the Python AI API (Flask) to fetch
 * predictions, patient data, profit forecasts, and recommendations.
 */
public class DoctorAnalyticsService {
    ...
    // ---------- AI Predictions (7‑day activity) ----------
    public Task<List<Map<String, Object>>> getAIPredictionsTask() {
        return new Task<>() {
            @Override
            protected List<Map<String, Object>> call() throws Exception {
                // Use the existing endpoint: /api/predict/doctor/<id>
                // Note: this endpoint returns predictions already.
                HttpRequest request = HttpRequest.newBuilder()
    ...
    // ---------- List of Patients for the Doctor ----------
    ...
    // ---------- Treatment Effectiveness Chart Data ----------
    ...
    public Task<List<String>> getAIRecommendationsTask() {
        return new Task<>() {
            @Override
            protected List<String> call() throws Exception {
                // Reuse the /recommendations endpoint
                HttpRequest request = HttpRequest.newBuilder()
