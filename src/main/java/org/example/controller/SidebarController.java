        ...
        if (event.getSource() instanceof Button) {
            ...
            switch (buttonText) {
                ...
                case "Trouver un Médecin":
                    navigateTo("doctor-search.fxml", "WellCare Connect - Trouver un Médecin");
                    break;
                case "Profil Médecin":
                    navigateTo("doctor-profile.fxml", "WellCare Connect - Profil Médecin");
                    break;
                case "Prendre RDV":
                    navigateTo("booking.fxml", "WellCare Connect - Prendre RDV");
                    break;
                case "Agenda":
                    navigateTo("doctor-schedule-week.fxml", "WellCare Connect - Agenda Médecin");
                    break;
                case "Résultats de Laboratoire":
                    navigateTo("lab-results.fxml", "WellCare Connect - Résultats de Laboratoire");
                    break;
