...
import com.wellora.javafx.service.DoctorAnalyticsService;
...
public class doc {
    ...
    private void displayPredictions(List<Map<String, Object>> predictions) {
        ...
        lastPredictionUpdateLabel.setText("Dernière mise à jour: " + LocalDate.now().format(DateTimeFormatter.ofPattern("HH:mm")));
    }
    ...
    private void displayProfitPredictions(Map<String, Object> profit) {
        ...
        if (profit == null || profit.isEmpty()) {
            Label empty = new Label("Données insuffisantes");
    ...
    private void generateQuickReport() {
        ...
        showAlert("Succès", "Rapport " + reportType + " généré pour le patient " + selected + " (" + period + ").");
    }

    private void generateQuickReport(DoctorAnalyticsService.Patient patient) {
        showAlert("Rapport", "Génération du rapport pour " + patient.getName());
    }
    ...
    private void viewPatientDetails(DoctorAnalyticsService.Patient patient) {
        ...
        details.getChildren().addAll(
                ...
                new Label("Âge: " + patient.getAge()),
                new Label("Score santé: " + patient.getHealthScore()),
                new Label("Dernière consultation: " + patient.getLastEntryDateFormatted())
        );
    ...
    private void sendMessageToPatient(DoctorAnalyticsService.Patient patient) {
        showAlert("Message", "Envoi d'un message à " + patient.getName());
    }
