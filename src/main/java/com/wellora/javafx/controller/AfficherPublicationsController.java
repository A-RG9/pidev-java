...
public class AfficherPublicationsController {
    ...
    private void goToAjouterPublication() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AjouterPublication.fxml"));
    ...
    private void goToGlobalFeed() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/ToutesPublications.fxml"));
