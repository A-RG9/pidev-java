    ...
    public void setData(parcours_de_sante p, Runnable refreshCallback) {
        ...
        if (btnEdit != null) {
            btnEdit.setOnAction(event -> {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ModifierParcoursDeSante.fxml"));
        ...
        if (btnInfo != null) {
            btnInfo.setOnAction(event -> {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/DetailsParcours.fxml"));
                    Parent root = loader.load();
