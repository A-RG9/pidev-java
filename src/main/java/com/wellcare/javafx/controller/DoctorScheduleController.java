...
public class DoctorScheduleController {
    ...
    private void updateSidebar() {
        ...
        if (todayApps.isEmpty()) {
            Label empty = new Label("Aucune disponibilitÃ©");
        ...
        if (upcoming.isEmpty()) {
            Label empty = new Label("Aucun rendez-vous Ã  venir");
            empty.setStyle("-fx-text-fill: #9ca3af; -fx-font-style: italic; -fx-padding: 12; -fx-alignment: center;");
            ...
            for (AppointmentDTO apt : upcoming) {
                ...
                Label nameReason = new Label(apt.getPatientName() + " Â· " + apt.getReason());
    ...
    @FXML private void openLeaveRequest() { showToast("Demande de congÃ© envoyÃ©e", "info"); }
