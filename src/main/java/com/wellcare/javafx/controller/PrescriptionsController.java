...
public class PrescriptionsController {
    ...
    private void displayPrescriptions() {
        ...
        if (prescriptions.isEmpty()) {
            prescriptionsCardsContainer.getChildren().add(
                createEmptyState("Aucune ordonnance", "Aucune ordonnance trouvÃ©e"));
            return;
        }
    ...
    private javafx.scene.Node createPrescriptionCard(Ordonnance prescription) {
        ...
        Label nameLabel = new Label(prescription.getMedicament() != null ? prescription.getMedicament() : "MÃ©dicament");
        ...
        Label dosageLabel = new Label(prescription.getDosage() != null ? prescription.getDosage() : "Ã€ dÃ©finir");
        ...
        Label durationLabel = new Label(prescription.getDureeTraitement() != null ? prescription.getDureeTraitement() : "Ã€ dÃ©finir");
        ...
        Label dateLabel = new Label(prescription.getDateOrdonnance() != null ? 
                                   "Du " + prescription.getDateOrdonnance().toString() : "Date Ã  dÃ©finir");
        ...
        Button downloadBtn = new Button("\uf019 TÃ©lÃ©charger");
    ...
    private void addSampleData() {
        try {
            ...
            o1.setDosage("1 comprimÃ© 3 fois par jour");
            o1.setDureeTraitement("5 jours");
            o1.setDateOrdonnance(java.time.LocalDate.now().minusDays(5));
            o1.setInstructions("Ã€ prendre aprÃ¨s les repas");
            o1.setForme("ComprimÃ©s");
            ...
            o2.setDosage("1 gÃ©lule 2 fois par jour");
            o2.setDureeTraitement("7 jours");
            o2.setDateOrdonnance(java.time.LocalDate.now().minusDays(10));
            o2.setInstructions("Ã€ prendre pendant les repas");
            o2.setForme("GÃ©lules");
            ...
            o3.setInstructions("Ã€ prendre entre les repas");
            o3.setForme("Sachets");
    ...
    private void handleMenuClick(ActionEvent event) {
        ...
        try {
            ...
            if (buttonText.contains("Tableau de bord")) {
            ...
            } else if (buttonText.contains("Trouver un MÃ©decin")) {
                ...
                stage.setScene(newScene);
                stage.setTitle("WellCare Connect - Trouver un MÃ©decin");
            } else if (buttonText.contains("Profil MÃ©decin")) {
                ...
                stage.setScene(newScene);
                stage.setTitle("WellCare Connect - Profil MÃ©decin");
            ...
            } else if (buttonText.contains("RÃ©sultats de Laboratoire")) {
                ...
                stage.setScene(newScene);
                stage.setTitle("WellCare Connect - RÃ©sultats de Laboratoire");
            } else if (buttonText.contains("Mon Profil")) {
                System.out.println("Navigate to profile");
            } else if (buttonText.contains("ParamÃ¨tres")) {
                System.out.println("Navigate to settings");
            } else if (buttonText.contains("DÃ©connexion")) {
