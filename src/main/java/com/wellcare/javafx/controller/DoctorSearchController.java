...
public class DoctorSearchController {
    ...
    private VBox createDoctorCard(Doctor doctor) {
        ...
        Label photoIcon = new Label("ðŸ‘¨â€âš•ï¸");
        ...
        Text exp = new Text("ðŸ’¼ " + doctor.experience + " years");
        exp.setStyle("-fx-font-size: 13;");
        
        Text loc = new Text("ðŸ“ " + doctor.location);
    ...
    private void toggleSubmenu(javafx.event.ActionEvent event) {
        ...
        System.out.println("SantÃ© submenu: " + santeSubmenuVisible + " | Rendez-vous submenu: " + rendezvousSubmenuVisible);
    }
    @FXML
