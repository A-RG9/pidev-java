...
public class ProfessionalRegistrationController implements ProfessionalTypeAware {
    ...
    private void updateStepIndicators(int activeStep) {
        ...
        switch (activeStep) {
            case 1:
                step1Indicator.getStyleClass().add("step-active");
                break;
            case 2:
                step2Indicator.getStyleClass().add("step-active");
                break;
            case 3:
                step3Indicator.getStyleClass().add("step-active");
                break;
        }
    }
    ...
    private boolean validateLicense() {
        String error = licenseField.getText().isEmpty() ? "Required" : ValidationUtils.validateNumericRange(licenseField.getText(), 0, 0, "dummy"); // Placeholder check
        // Real license check
