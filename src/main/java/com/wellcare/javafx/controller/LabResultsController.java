...
public class LabResultsController {
    ...
    private void displayLabResults() {
        ...
        if (labResults.isEmpty()) {
            labResultsCardsContainer.getChildren().add(
                createEmptyState("Aucun rÃ©sultat", "Aucun rÃ©sultat de laboratoire disponible."));
            return;
        }
    ...
    private javafx.scene.Node createLabResultCard(Examens result) {
        ...
        Button uploadPdfButton = new Button("ðŸ“¤ Upload PDF");
        ...
        if (result.getResultFile() != null && !result.getResultFile().isEmpty()) {
            Button viewPdfButton = new Button("ðŸ“„ Voir PDF");
        ...
        Button viewDetailsButton = new Button("ðŸ‘ Voir DÃ©tails");
    ...
    private void openPdfFile(String filePath) {
        try {
            ...
            if (file.exists()) {
                ...
                showAlert("Fichier non trouvÃ©", "Le fichier PDF n'existe pas: " + filePath);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void uploadPdfFile(Examens result) {
        ...
        if (selectedFile != null) {
            try {
                ...
                showAlert("SuccÃ¨s", "Fichier PDF uploadÃ© avec succÃ¨s!");
    ...
    private void showExamDetails(Examens result) {
        String details = "Type: " + (result.getTypeExamen() != null ? result.getTypeExamen() : "N/A") + "\n" +
                       ...
                       "RÃ©sultat: " + (result.getResultat() != null ? result.getResultat() : "N/A") + "\n\n" +
                       "Analyse MÃ©decin: " + (result.getDoctorAnalysis() != null ? result.getDoctorAnalysis() : "N/A") + "\n\n" +
                       "Traitement: " + (result.getDoctorTreatment() != null ? result.getDoctorTreatment() : "N/A") + "\n\n" +
                       "Notes: " + (result.getNotes() != null ? result.getNotes() : "N/A");
        
        showAlert("DÃ©tails de l'Examen", details);
    }
    ...
    private void loadLabResults() {
        try {
            ...
            showAlert("Erreur de connexion", "Impossible de charger les rÃ©sultats: " + e.getMessage());
    ...
    private void handleMenuClick(ActionEvent event) {
        ...
        try {
            ...
            switch (buttonText) {
                ...
                case "Mon Profil":
                    showAlert("Mon Profil", "Page de profil utilisateur Ã  implÃ©menter");
                    break;
                    
                case "ParamÃ¨tres":
                    showAlert("ParamÃ¨tres", "Page de paramÃ¨tres Ã  implÃ©menter");
                    break;
                    
                case "DÃ©connexion":
                    showAlert("DÃ©connexion", "Voulez-vous vraiment vous dÃ©connecter?");
                    break;
            }
            stage.show();
        } catch (Exception e) {
